...
- 1.1% of the region's population report a disability while working in Business Services
...
write.xlsx(dis_covemp_fmt, file.path(outdir, "disability_covemp_pums_2019-2022.xlsx"))
```
...
- Increased workers with disabilities in Services and Public Education